...
class MongoDbVersion4_2_Test {
    ...
    @Container
    static MongoDBContainer mongoDbVersion4_2 = new MongoDBContainer(DockerImageName.parse("mongo:4.2"));

    @DynamicPropertySource
    static void setProperties(final DynamicPropertyRegistry registry) {
        registry.add("spring.data.mongodb.uri", mongoDbVersion4_2::getReplicaSetUrl);
    }
